...
function AdminArticlesList({articles}) {
            ...
            articles.map((article, idx) => {
                return (
                    <div className={styles.card} key={idx}>
                        <img src={article.imageUrl} alt={article.imageUrl} className={styles.image}/>
                        ...
                        <div className={styles.text_content_container}>
                            ...
                            <div className={styles.space_between_container}>
                                <p>{article.subCategory} / {article.location}</p>
                                {article.isPublished && <p className={styles.published}>Published</p>}
                            </div>
                        </div>
                    </div>
                )
